-- Mang Herbal — داتابەیسی تەواو بۆ Neon
-- هەموو ئەم فایلە کۆپی بکە (Ctrl+A)، بیخەرە SQL Editor ی Neon و یەکجار Run بکە.
-- ئەم دوو دێڕە کۆنەکە بە تەواوی پاک دەکەنەوە، پاشان هەموو داتاکە دادەنرێتەوە:
...
-- ئەگەر ژمارەکەی خوارەوە 11 بوو، هەموو شتێک سەرکەوتووە:
